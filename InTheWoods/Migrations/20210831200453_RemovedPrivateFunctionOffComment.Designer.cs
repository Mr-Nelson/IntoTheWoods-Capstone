...
namespace InTheWoods.Migrations
{
    ...
    [Migration("20210831200453_RemovedPrivateFunctionOffComment")]
    partial class RemovedPrivateFunctionOffComment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InTheWoods.Models.Admin", b =>
                {
            ...
            modelBuilder.Entity("InTheWoods.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "c0f71732-8ca2-4c7e-811f-7101613e2baf",
                            ConcurrencyStamp = "6cd19096-9a4b-4999-9bae-2c2b8d4a7a28",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "1381bac1-1c2a-4b84-ad49-7ddfff10c4ff",
                            ConcurrencyStamp = "5e4630c6-0a2b-42ea-a4f3-fd96c94accdc",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InTheWoods.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
