...
namespace InTheWoods.Managers
{
    public class AuthenticationManager : IAuthenticationManager
    {
        ...
        //private readonly AdminManager<Admin> _adminManager;
        private readonly IConfiguration _configuration;
        private User _user;
        //private Admin _admin;

        public AuthenticationManager(UserManager<User> userManager, /*AdminManager<Admin> _adminManager,*/ IConfiguration configuration)
        {
